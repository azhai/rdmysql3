...
from rdmysql3 import Daily, Row, Expr, iter_daily
...
class TestUserProfile(fixure.TestBase):
    ...
    def test_01_iter_all(self):
        ...
        rows = iter_daily(self.event, query_all, stop=date(2024,3,1), fuse=True)
        # 大约200行
    ...
    def test_02_iter_cate(self):
        ...
        rows = iter_daily(self.event, query_cate, stop=date(2024,3,1))
